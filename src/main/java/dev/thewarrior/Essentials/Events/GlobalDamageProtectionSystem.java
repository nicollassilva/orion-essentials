...
public class GlobalDamageProtectionSystem extends WorldEventSystem<EntityStore, BreakBlockEvent> {
    private final RegionManager regionManager;
    private final String regionFlag;

    public GlobalDamageProtectionSystem(RegionManager regionManager) {
